...
#install.packages(c("mvtnorm", "sm", "iRegression", "quantreg", "robustbase", "doParallel"))
...
ETKRRP =  function(y1, x1, y2, x2, s, t = NULL, tol = 1e-10, maxit = 100, tolsolve = 1e-100) {
  ...
  if (!is.null(t)){
    ...
    if(!is.null(s)){
      hp1 = switch(s[1], S1 = S1(y1, yhat1), S2 = S2_cpp(y1, yhat1), S3 = S3(y1, yhat1, n, p), S4 = S4(y1, yhat1))
      hp2 = switch(s[1], S1 = S1(y2, yhat2), S2 = S2_cpp(y2, yhat2), S3 = S3(y2, yhat2, n, p), S4 = S4(y2, yhat2))}
  ...
  #CASO 2, HIPERPARAMETROS DIFERENTES
    ...
    hp1 = switch(s[1], S1 = S1(y1, yhat1), S2 = S2_cpp(y1, yhat1), S3 = S3(y1, yhat1, n, p), S4 = S4(y1, yhat1))
    hp2 = switch(s[2], S1 = S1(y2, yhat2), S2 = S2_cpp(y2, yhat2), S3 = S3(y2, yhat2, n, p), S4 = S4(y2, yhat2))
